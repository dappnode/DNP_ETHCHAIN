...
Actually based on version v1.9.8 of [Geth](https://github.com/ethereum/go-ethereum/releases/tag/v1.9.8) and version v2.6.4-beta of [Parity](https://github.com/paritytech/parity/releases/tag/v2.6.4)
