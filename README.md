...
Actually based on version v2.3.8-stable of [Parity](https://github.com/paritytech/parity/releases/tag/v2.3.8) and compatible with Constantinople postponement. 
