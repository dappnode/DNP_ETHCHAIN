...
Actually based on version v2.2.7-stable of [Parity](https://github.com/paritytech/parity/releases/tag/v2.2.7) and compatible with Constantinople postponement. 
